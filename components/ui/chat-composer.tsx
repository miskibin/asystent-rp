...
/** Copied from miskibin/chat-components: a controlled, text-only composer. */
  ...
  return (
    <div data-slot="chat-composer" className={cn("w-full", className)}>
      <div
        ...
        className="relative rounded-xl border bg-background p-2 shadow-sm transition-shadow focus-within:ring-2 focus-within:ring-ring/50"
      >
        <textarea
          ref={textareaRef}
        ...
        {isGenerating ? (
          <button
            ...
            onClick={onStop}
            className="absolute bottom-2 right-2 grid h-9 w-9 place-items-center rounded-lg bg-foreground text-background outline-none transition-colors hover:opacity-85 focus-visible:ring-2 focus-visible:ring-ring/50"
          >
          ...
          <button
            ...
            disabled={!canSend}
            onClick={onSend}
            className="absolute bottom-2 right-2 grid h-9 w-9 place-items-center rounded-lg bg-primary text-primary-foreground outline-none transition-colors hover:bg-primary/90 focus-visible:ring-2 focus-visible:ring-ring/50 disabled:pointer-events-none disabled:opacity-35"
          >
